            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="d-flex flex-column h-100">
                  <p class="mb-1 pt-2 text-bold">Criado por Harrys Company</p>
                  <h5 class="font-weight-bolder">Dashboard para Acompanhamento</h5>
                  <p class="mb-5">
            ...
            <div class="card-body position-relative z-index-1 p-3 h-100">
              <div class="d-flex flex-column h-100">
                ...
                <p class="text-white mb-5">
                  A riqueza requer atitude e atitude requer coragem<br>
                  É sobre quem abraça a oportunidade primeiro.
                </p>
                <a
